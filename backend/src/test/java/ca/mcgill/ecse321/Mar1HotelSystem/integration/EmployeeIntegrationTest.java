...
public class EmployeeIntegrationTest {
    ...
    public void testGetShift() {
         ...
         * Even if I try to set it, for example in the @BeforeEach and @AfterEach
         * methods, the fact that
         * I need to save the new id with the DAO means that it will be changed again. I
         * didn't have this
         * issue in the service tests because of Mock, which always returns the id I set
         * (unlike a real database).
         * 
         * So, I just get the first shift in the list and use its id (since I know there
         * is only 1 shift in the list).
