...
public class ScheduleIntegrationTest {
    ...
    public void CreateOperatingHours(OperatingHoursRequestDto request) {
        ...
        ResponseEntity<OperatingHoursResponseDto> response = client.postForEntity("/operatingHours/create", request, OperatingHoursResponseDto.class);
    ...
    public void GetOperatingHoursByDay(OperatingHoursRequestDto request) {
        ...
        ResponseEntity<OperatingHoursResponseDto> response = client.getForEntity("/operatingHours/day/"+day, OperatingHoursResponseDto.class);
    ...
    public void UpdateOperatingHours(OperatingHoursRequestDto updatedRequest) {
        ...
        ResponseEntity<OperatingHoursResponseDto> response = client.postForEntity("/operatingHours/update", updatedRequest, OperatingHoursResponseDto.class);
    ...
    public void CreateCustomHours(CustomHoursRequestDto request) {
        ResponseEntity<CustomHoursResponseDto> response = client.postForEntity("/customHours/create", request, CustomHoursResponseDto.class);
    ...
    public void updateCustomHours(CustomHoursRequestDto request) {
        ...
        ResponseEntity<CustomHoursResponseDto> response = client.postForEntity("/customHours/update", request, CustomHoursResponseDto.class);
    ...
    public void deleteCustomHourByDate(CustomHoursRequestDto request) {
        ...
        ResponseEntity<CustomHoursResponseDto> response = client.postForEntity("customHours/{date}"+dateString, request, CustomHoursResponseDto.class); //TODO: fix issue with accessing based on date
    ...
    public void createHotelSchedule(HotelScheduleRequestDto request){
        ...
        ResponseEntity<HotelScheduleResponseDto> response = client.postForEntity("/hotelSchedule/create", request, HotelScheduleResponseDto.class);

        assertNotNull(response);
        assertEquals(HttpStatus.CREATED, response.getStatusCode());
        assertNotNull(response.getBody());
        assertEquals(request.getYear(), response.getBody().getYear());
        assertEquals(request.getOperatingHoursList(), response.getBody().getOperatingHoursList());
        assertEquals(request.getCustomHoursList(), response.getBody().getCustomHoursList());
    }
    ...
    public void getHotelScheduleByYear(HotelScheduleRequestDto request) {
        ...
        ResponseEntity<HotelScheduleResponseDto> response = client.getForEntity("/hotelSchedule/year/"+year, HotelScheduleResponseDto.class);
