 ...
 * It is responsible for creating, updating, deleting, and retrieving the
 * operating hours, custom hours, and hotel schedule.
 * 
...
public class ScheduleRestController {
    ...
    public ResponseEntity<OperatingHoursResponseDto> deleteOperatingHoursByDay(@PathVariable("day") DayOfWeek day) {
        ...
        return new ResponseEntity<OperatingHoursResponseDto>(new OperatingHoursResponseDto(deletedOperatingHours),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<CustomHoursResponseDto> deleteCustomHoursByDate(@PathVariable("date") Date date) {
        ...
        return new ResponseEntity<CustomHoursResponseDto>(new CustomHoursResponseDto(deletedCustomHours),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<HotelScheduleResponseDto> createHotelSchedule(
            @RequestBody HotelScheduleRequestDto hotelScheduleRequestDto) {
