...
public class MarwaanHotelSystemApplication {
	...
	public Room getRoom(int index){
	  ...
	  public Room addRoom(RoomType roomType, BedType bedType, boolean isAvailable, int pricePerNight, int maxCapacity, Hotel hotel){
	  ...
	  public boolean addRoom(Room room){
		...
		boolean isNewMarwaanHotelSystemApplication = existingMarwaanHotelSystemApplication != null && !this.equals(existingMarwaanHotelSystemApplication);
	...
	public CustomHours getCustomHours(int index){
	  ...
	  public boolean addCustomHours(CustomHours customHours){
		...
		MarwaanHotelSystemApplication existingMarwaanHotelSystemApplication = customHours.getMarwaanHotelSystemApplication();
		boolean isNewMarwaanHotelSystemApplication = existingMarwaanHotelSystemApplication != null && !this.equals(existingMarwaanHotelSystemApplication);
		if (isNewMarwaanHotelSystemApplication){
	...
	public OperatingHours getOperatingHours(int index){
	  ...
	  public boolean addOperatingHours(OperatingHours operatingHours){
		...
		MarwaanHotelSystemApplication existingMarwaanHotelSystemApplication = operatingHours.getMarwaanHotelSystemApplication();
		boolean isNewMarwaanHotelSystemApplication = existingMarwaanHotelSystemApplication != null && !this.equals(existingMarwaanHotelSystemApplication);
		if (isNewMarwaanHotelSystemApplication){
	...
	public HotelSchedule getHotelSchedule(int index){
	  ...
	  public boolean addHotelSchedule(HotelSchedule hotelSchedule){
		...
		MarwaanHotelSystemApplication existingMarwaanHotelSystemApplication = hotelSchedule.getMarwaanHotelSystemApplication();
		boolean isNewMarwaanHotelSystemApplication = existingMarwaanHotelSystemApplication != null && !this.equals(existingMarwaanHotelSystemApplication);
		if (isNewMarwaanHotelSystemApplication){
	...
	public Payment getPayment(int index){
	  ...
	  public boolean addPayment(Payment payment){
		...
		MarwaanHotelSystemApplication existingMarwaanHotelSystemApplication = payment.getMarwaanHotelSystemApplication();
		boolean isNewMarwaanHotelSystemApplication = existingMarwaanHotelSystemApplication != null && !this.equals(existingMarwaanHotelSystemApplication);
		if (isNewMarwaanHotelSystemApplication){
	...
	public Booking getBooking(int index){
	  ...
	  public boolean addBooking(Booking booking){
		...
		MarwaanHotelSystemApplication existingMarwaanHotelSystemApplication = booking.getMarwaanHotelSystemApplication();
		boolean isNewMarwaanHotelSystemApplication = existingMarwaanHotelSystemApplication != null && !this.equals(existingMarwaanHotelSystemApplication);
		if (isNewMarwaanHotelSystemApplication){
	...
	public Request getRequest(int index){
	  ...
	  public boolean addRequest(Request request){
		...
		MarwaanHotelSystemApplication existingMarwaanHotelSystemApplication = request.getMarwaanHotelSystemApplication();
		boolean isNewMarwaanHotelSystemApplication = existingMarwaanHotelSystemApplication != null && !this.equals(existingMarwaanHotelSystemApplication);
		if (isNewMarwaanHotelSystemApplication){
